...
import dataset_seq2seqV3 as dataset
...
parser.add_argument('--train_root', default='data/images/trainV3label.txt', help='path to training dataset')
parser.add_argument('--valid_root', default='data/images/validV3label.txt', help='path to testing dataset')
parser.add_argument('--alphabet', default='data/images/alphabet.txt', help='')
parser.add_argument('--num_workers', type=int, default=2, help='number of data loading num_workers')
