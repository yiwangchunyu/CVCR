...
if __name__=="__main__":
    ...
    parser.add_argument('--num_samples', type=int, default=5000, help='')
    parser.add_argument('--trainRoot', type=str, default='data/images/trainV2', help='')
    parser.add_argument('--validRoot', type=str, default='data/images/validV2', help='')
    parser.add_argument('--testRoot', type=str, default='data/images/testV2', help='')
    parser.add_argument('--trainLabelPath', type=str, default='data/images/trainV2label.txt', help='')
    parser.add_argument('--validLabelPath', type=str, default='data/images/validV2label.txt', help='')
    parser.add_argument('--testLabelPath', type=str, default='data/images/testV2label.txt', help='')
